...
const SCAN_URL = 'https://share-text.vercel.app/api/cron/scan'
const CF_SCAN_URL = 'https://share-text-b1s.pages.dev/api/cron/scan'
...
describe('normalizeJobUrl', () => {
  it('ignores trailing slashes and case', () => {
    expect(normalizeJobUrl('https://Share-Text.Vercel.App/api/cron/scan/')).toBe(SCAN_URL)
  })
})
