<script lang="ts" generics="TState">
  ...
  let { tabs, state: tabState, pathname, ariaLabel = 'Tabs', class: className = '', headerClass = 'sticky top-0 z-10 flex w-full flex-wrap items-center justify-between gap-2 bg-slate-950 pb-3 pt-4' }: Props<TState> = $props()
